  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      >
        ...
        <p className="mt-1 text-sm text-neutral-500">Sign in to continue to Velmont.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
          ...
          <Link to="/forgot-password" className="-mt-2 self-end text-xs font-medium text-neutral-500 underline">
            Forgot password?
          </Link>
        ...
        <Link to="/home" className="mt-4 block text-center text-xs text-neutral-400">
